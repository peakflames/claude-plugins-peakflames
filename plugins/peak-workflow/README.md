...
| `/wrapup-epic <id>` | Independent review — verifies each TOR's Given/When/Then is satisfied, asks fix-now-or-defer on every gap, closes out, ships; runs on Opus in a fresh session | Implemented → **Complete** |
