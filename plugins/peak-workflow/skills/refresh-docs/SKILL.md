...
**Important:** `docs/architecture.md` and `docs/design-notes.md` describe the system's
architecture and design decisions. They do **not** contain TOR requirements. The requirements
baseline lives in `docs/requirements/*.feature.md` — that is maintained by
`/peak-workflow:capture-requirements`, not by this skill. Do not move, copy, or summarize
TOR requirements into `architecture.md` or `design-notes.md`.
